...
Команда \`/authorize\` подключает сторонние сервисы (например, Google, GitHub или Microsoft) к вашему агенту OpenClaw AI. После подключения агент сможет взаимодействовать с этими сервисами от вашего имени.

---

## Как это работает

1. Отправьте \`/authorize\` в Telegram-чате
